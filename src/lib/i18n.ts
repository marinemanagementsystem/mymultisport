...
export type LanguageCode = 'tr' | 'en' | 'pl' | 'ar';
...
export const SUPPORTED_LANGUAGES: LanguageMeta[] = [
  ...
  { code: 'ar', label: 'Arabic', nativeLabel: 'العربية', htmlLang: 'ar', locale: 'ar', dir: 'rtl' },
];
...
const translations: Record<LanguageCode, TranslationDictionary> = {
  ...
  ar: {
    'app.description': 'اكتشف مرافق تركيا حسب التقييم والقرب والقوائم الشخصية.',
    'language.label': 'اللغة',
    'language.selectLabel': 'لغة التطبيق',
    'stats.results': 'النتائج',
    'stats.rated': 'مقيّمة',
    'stats.favorite': 'المفضلة',
    'stats.visited': 'زرتها',
    'panels.discover': 'اكتشف',
    'panels.updates': 'التحديثات',
    'panels.compare': 'قارن',
    'filters.show': 'إظهار الفلاتر',
    'filters.hide': 'إخفاء الفلاتر',
    'filters.activeCount': '{count} نشطة',
    'filters.all': 'الكل',
    'filters.searchLabel': 'ابحث عن مرفق أو منطقة أو ميزة أو نشاط',
    'filters.searchPlaceholder': 'ابحث عن مرفق أو منطقة أو ميزة أو نشاط',
    'filters.city': 'المدينة',
    'filters.district': 'المنطقة',
    'filters.activity': 'النشاط',
    'filters.sort': 'الترتيب',
    'filters.distance': 'المسافة',
    'filters.card': 'البطاقة',
    'filters.personal': 'شخصي',
    'filters.amenity': 'ميزة',
    'filters.minRating': 'أدنى تقييم',
    'filters.minReviews': 'أدنى عدد مراجعات',
    'filters.hours': 'ساعات العمل',
    'filters.start': 'البداية',
    'filters.time': 'الوقت',
    'filters.end': 'النهاية',
    'filters.activeOnly': 'نشط',
    'filters.withPhoto': 'مع صورة',
    'filters.global': 'عالمي',
    'filters.myLocation': 'موقعي',
    'filters.fetchRatingsHours': 'جلب التقييم/الساعات',
    'filters.clear': 'مسح الفلاتر',
    'placeholders.allCities': 'كل المدن',
    'placeholders.allDistricts': 'كل المناطق',
    'placeholders.allActivities': 'كل الأنشطة',
    'placeholders.allCards': 'كل البطاقات',
    'placeholders.allAmenities': 'كل الميزات',
    'sort.recommended': 'موصى به',
    'sort.distance': 'المسافة',
    'sort.rating': 'تقييم Google',
    'sort.reviews': 'عدد المراجعات',
    'sort.az': 'A-Z',
    'personal.favorite': 'المفضلة',
    'personal.favorites': 'المفضلة',
    'personal.wantToGo': 'أريد الذهاب',
    'personal.visited': 'زرتها',
    'personal.visitedAction': 'زرتها',
    'personal.noted': 'مع ملاحظات',
    'personal.plan': 'خطط',
    'hours.all': 'الكل',
    'hours.openNow': 'مفتوح الآن',
    'hours.closedNow': 'مغلق الآن',
    'hours.openAt': 'مفتوح في هذا الوقت',
    'hours.openUntil': 'مفتوح حتى هذا الوقت',
    'hours.openBetween': 'مفتوح خلال الفترة',
    'hoursSummary.open': 'مفتوح',
    'hoursSummary.openUntil': 'مفتوح · حتى {time}',
    'hoursSummary.closed': 'مغلق',
    'hoursSummary.opensAt': 'مغلق · يفتح {time}',
    'status.loadingFacilities': 'جار تحميل مرافق MultiSport...',
    'status.noResults': 'لم يتم العثور على مرافق بهذه الفلاتر.',
    'facility.cardFallback': 'بطاقة',
    'facility.global': 'عالمي',
    'facility.international': 'دولي',
    'facility.noHours': 'لا توجد معلومات ساعات',
    'facility.hoursPending': 'الساعات قيد الانتظار',
    'facility.reviews': 'مراجعة',
    'facility.noReviews': 'لا توجد مراجعات',
    'facility.ratingPending': 'التقييم قيد الانتظار',
    'facility.matchAmbiguous': 'المطابقة غير واضحة',
    'facility.googleNotFound': 'لا يوجد سجل Google',
    'facility.detail': 'التفاصيل',
    'facility.compare': 'قارن',
    'facility.googleMaps': 'خرائط Google',
    'updates.emptySummary': 'لم يتم إنشاء ملخص تغييرات بعد. سيتم إنشاء ملخص ثابت في مزامنة/بناء المرافق التالي.',
    'updates.dataUpdate': 'تحديث البيانات',
    'updates.changed': 'تغيير',
    'updates.updatedFromTo': 'تم التحديث من {previous} مرفق إلى {current} مرفق.',
    'updates.newFacilities': 'مرافق جديدة',
    'updates.removedFacilities': 'مرافق محذوفة',
    'updates.updatedFacilities': 'مرافق محدثة',
    'updates.noRecords': 'لا توجد سجلات في هذا البناء.',
    'compare.empty': 'اختر مرفقين على الأقل من القائمة للمقارنة. يمكن تقييم ما يصل إلى أربعة مرافق جنبًا إلى جنب.',
    'compare.remove': 'إزالة',
    'compare.openDetail': 'فتح التفاصيل',
    'main.lightMode': 'الوضع الفاتح',
    'main.darkMode': 'الوضع الداكن',
    'main.exitFullscreen': 'الخروج من ملء الشاشة',
    'main.fullscreen': 'ملء الشاشة',
    'main.pinsGrouped': 'تم تجميع {count} دبوس',
    'main.firstResultsFrom': ' / أول {shown} من {total} نتيجة',
    'main.listView': 'عرض القائمة',
    'main.mapView': 'عرض الخريطة',
    'mapFallback.title': 'مفتاح Google Maps Browser مطلوب',
    'mapFallback.body': 'القائمة والفلاتر وبيانات مرافق MultiSport تعمل. لفتح الخريطة، أضف مفتاح Maps JavaScript API باسم {key} ثم أعد بناء التطبيق.',
    'mapFallback.note': 'مفتاح تقييمات Google Places لا يوضع في العميل؛ يبقى سرًا في Firebase Functions.',
    'map.legend': 'أزرق: مقيّم · رمادي: قيد الانتظار · أسود: مجموعة',
    'map.openGoogleMaps': 'افتح في خرائط Google',
    'map.clusterTitle': '{count} مرفق',
    'map.userLocation': 'موقعك',
    'drawer.detailTitle': 'تفاصيل المرفق',
    'drawer.close': 'إغلاق التفاصيل',
    'drawer.rating': 'التقييم',
    'drawer.review': 'المراجعات',
    'drawer.distance': 'المسافة',
    'drawer.workingHours': 'ساعات العمل',
    'drawer.personalList': 'القائمة الشخصية',
    'drawer.personalNote': 'ملاحظة شخصية',
    'drawer.notePlaceholder': 'مثال: أهدأ في أيام الأسبوع، الموقف سهل...',
    'drawer.activities': 'الأنشطة',
    'drawer.amenities': 'الميزات',
    'drawer.discounts': 'الخصومات',
    'drawer.commentsDisabledTitle': 'تعليقات المستخدمين متوقفة',
    'drawer.commentsDisabledBody': 'لم تتم إضافة تعليقات المستخدمين في جولة التطوير الأولى حتى لا تتغير التكلفة ونطاق الإشراف.',
    'drawer.openInMap': 'افتح على الخريطة',
    'drawer.removeCompare': 'إزالة من المقارنة',
    'drawer.addCompare': 'إضافة إلى المقارنة',
    'errors.facilitiesLoadFailed': 'تعذر تحميل قائمة المرافق.',
    'errors.cacheReadFailed': 'تعذر قراءة ذاكرة التقييمات؛ لا تزال قائمة المرافق قابلة للاستخدام.',
    'errors.geolocationUnsupported': 'خدمات الموقع غير مدعومة على هذا الجهاز.',
    'errors.geolocationDenied': 'لم يتم منح إذن الموقع. يمكنك المتابعة بفلاتر المدينة/المنطقة.',
    'errors.apiMissing': 'عنوان Firebase API غير مضبوط في التطوير المحلي. التقييمات تعمل بعد النشر أو مع VITE_API_BASE_URL.',
    'errors.noRefreshRemaining': 'لا توجد مرافق متبقية للتحديث في هذا العرض.',
    'errors.quotaReached': 'اكتملت حصة التقييم اليومية. يمكنك المتابعة بالذاكرة الحالية.',
    'errors.googleRatingsFailed': 'تعذر جلب تقييمات Google.',
    'errors.compareMax': 'يمكن اختيار 4 مرافق كحد أقصى للمقارنة.',
    'errors.apiHealthFailed': 'فشل فحص API ({status})',
    'errors.ratingsCacheFailedStatus': 'تعذر قراءة ذاكرة التقييمات ({status})',
    'errors.ratingsEnrichFailedStatus': 'تعذر تحديث تقييمات Google ({status})',
  },
};
...
const countUnits: Record<LanguageCode, Record<CountUnit, CountUnitForms>> = {
  ...
  ar: {
    facility: { one: 'مرفق', two: 'مرفقان', few: 'مرافق', many: 'مرفق', other: 'مرفق' },
    result: { one: 'نتيجة', two: 'نتيجتان', few: 'نتائج', many: 'نتيجة', other: 'نتيجة' },
    change: { one: 'تغيير', two: 'تغييران', few: 'تغييرات', many: 'تغيير', other: 'تغيير' },
    review: { one: 'مراجعة', two: 'مراجعتان', few: 'مراجعات', many: 'مراجعة', other: 'مراجعة' },
    pin: { one: 'دبوس', two: 'دبوسان', few: 'دبابيس', many: 'دبوس', other: 'دبوس' },
  },
};
