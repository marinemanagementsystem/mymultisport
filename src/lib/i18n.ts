...
const tr = {
  ...
  'status.showingResults': '{total} sonuçtan {shown} gösteriliyor',
  'status.showMore': 'Daha fazla göster',
  ...
  'main.mapFilteredResults': '{count} filtrelenmiş tesis',
  'main.mapViewportNote': ' · harita görünen bölgeyi gösterir',
...
const translations: Record<LanguageCode, TranslationDictionary> = {
  ...
  en: {
    ...
    'status.showingResults': 'Showing {shown} of {total} results',
    ...
    'main.mapFilteredResults': '{count} filtered facilities',
    'main.mapViewportNote': ' · map follows the visible area',
  ...
  pl: {
    ...
    'status.showingResults': 'Wyświetlono {shown} z {total} wyników',
    'status.showMore': 'Pokaż więcej',
    ...
    'main.mapFilteredResults': '{count} filtrowanych obiektów',
    'main.mapViewportNote': ' · mapa pokazuje widoczny obszar',
